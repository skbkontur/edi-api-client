...
- В информацию об универсальном сообщении добавлен создатель; идентификатор титула уточнён до `DocumentTitleEntityId`.
...
## v2.18.3 - 2025.11.05
- Добавлены статусные GisMt в ящике получателя
