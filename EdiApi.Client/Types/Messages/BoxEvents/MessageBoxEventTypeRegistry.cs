...
namespace SkbKontur.EdiApi.Client.Types.Messages.BoxEvents
{
    public class MessageBoxEventTypeRegistry : BoxEventTypeRegistry<MessageBoxEventType>
    {
        public MessageBoxEventTypeRegistry()
        {
            ...
            Register<InboxDiadocDocumentRevocationGisMtStatusChanged>(MessageBoxEventType.InboxDiadocDocumentRevocationGisMtStatusChanged);
            Register<OutboxDiadocDocumentGisMtStatusChanged>(MessageBoxEventType.OutboxDiadocDocumentGisMtStatusChanged);
            Register<OutboxDiadocDocumentRevocationGisMtStatusChanged>(MessageBoxEventType.OutboxDiadocDocumentRevocationGisMtStatusChanged);
        }
    }
}