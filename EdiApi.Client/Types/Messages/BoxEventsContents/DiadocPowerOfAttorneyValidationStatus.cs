...
namespace SkbKontur.EdiApi.Client.Types.Messages.BoxEventsContents
{
    ...
    public class DiadocPowerOfAttorneyValidationStatus
    {
        ...
        /// <summary>Ошибки проверки МЧД. Устаревшее свойство</summary>
        [Obsolete("Используйте свойства ValidationProtocol и OperationError с более полной информацией о проверке МЧД")]
